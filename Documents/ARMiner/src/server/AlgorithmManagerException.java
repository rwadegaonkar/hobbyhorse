...
/**
   ...
   AlgorithmManagerException.java<P>

   Exception thrown by AlgorithmManager.
...
public class AlgorithmManagerException extends Exception
{
  /** 
   * @serial
   */
   ...
   */
  public AlgorithmManagerException(String name)
  {
    text = name;
  }
