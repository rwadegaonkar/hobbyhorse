...
/*
  ...
  Nov. 19th, 2000   - I fixed a potential problem related to a bad
                      way of initializing RandomSample, now I create
                      one Random object and use it in all RandomSample
                      objects. Also I use randTransaction as a source
                      of random numbers for nextTransaction.

*/

/**

   SyntheticDataGenerator.java<P>
   ...
   Mr. Rakesh Agrawal and the Master Thesis of Mr. Andreas Mueller.<P>
